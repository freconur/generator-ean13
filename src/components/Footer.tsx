    ...
    <>
          ...
          <div className={styles.mainSection}>
            ...
            <div className={styles.linksSection}>
              ...
              <div className={styles.linkGroup}>
                ...
                <ul className={styles.linkList}>
                  <li>
                    <a href={`https://wa.me/${limits.whatsappNumber}?text=Hola,%20tengo%20una%20pregunta%20sobre%20izicode`} target="_blank" rel="noopener noreferrer" className={styles.link}>
                      Soporte WhatsApp
                    </a>
                  </li>
                  <li>
      ...
      >
        <div className={styles.buttonContent}>
          ...
          <span className={styles.buttonText}>¿Necesitas ayuda?</span>
        </div>
      </a>
    </>
  );
